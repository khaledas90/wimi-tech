          ...
          items.map((src, i) => (
            <SwiperSlide key={i}>
              <div className="block w-full h-full">
                <div
                  className={`relative w-full ${height} aspect-[16/9] sm:aspect-[16/9] md:aspect-[16/9] lg:aspect-[16/9] xl:aspect-[16/9]  flex items-center justify-center overflow-hidden rounded-xl`}
                >
                  {src.image ? (
                    <Image
                      src={src.image}
