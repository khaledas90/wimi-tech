          ...
          <div className="py-8">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                <div
                  className={`px-3 py-1 mx-2 rounded-full text-sm font-medium ${
                ...
                <button
                  onClick={() => refreshTraderData()}
                  className="inline-flex items-center mx-3 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 mx-2 focus:ring-offset-2 focus:ring-blue-500"
                >
